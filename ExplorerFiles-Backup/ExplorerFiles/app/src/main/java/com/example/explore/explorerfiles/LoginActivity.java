...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void populateAutoComplete() {
        if (!mayRequestContacts() || !mayRequestStorage() || !mayRequestRecord()) {
            return;
        }
    ...
    private boolean mayRequestRecord(){
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M){
            return true;
        }
        if(checkSelfPermission(RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED){
            ...
            requestPermissions(new String[]{RECORD_AUDIO},REQUEST_RECORD);
        }
        return false;
    }
...
//            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                finish();
                Intent intent = new Intent(LoginActivity.this,AudioPicker.class);
